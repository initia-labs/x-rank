...
const mockAccounts: ReadonlyArray<Omit<Account, "currentPostingStreak" | "longestPostingStreak" | "postingActivity">> =
  [
    {
      id: "maya",
      name: "Maya Chen",
    ...
    },
    {
      ...
      followerHistory: [],
      hourlyEngagement: [
        4, 2, 0, 0, 0, 0, 8, 30, 90, 180, 280, 360, 320, 280, 240, 200, 150, 110, 80, 60, 40, 22, 12, 6
      ]
    },
    {
      id: "nora",
    ...
    },
    {
      ...
      followerHistory: [],
      hourlyEngagement: [
        0, 0, 0, 0, 0, 6, 30, 70, 140, 220, 290, 350, 320, 260, 200, 160, 120, 90, 70, 60, 40, 26, 14, 8
      ]
    },
    {
      id: "jules",
    ...
    },
    {
      ...
      followerHistory: [],
      hourlyEngagement: [
        0, 0, 0, 0, 0, 0, 6, 32, 100, 200, 280, 320, 290, 240, 200, 160, 120, 90, 70, 50, 36, 20, 10, 4
      ]
    },
    {
      id: "omar",
      ...
      followerHistory: [],
      hourlyEngagement: [
        2, 0, 0, 0, 0, 0, 8, 36, 120, 220, 290, 340, 320, 260, 200, 160, 120, 90, 70, 60, 44, 28, 14, 6
      ]
    },
    {
      id: "ivy",
    ...
    },
    {
      ...
      followerHistory: [],
      hourlyEngagement: [
        0, 0, 0, 0, 0, 0, 6, 30, 90, 170, 220, 240, 220, 200, 180, 150, 130, 110, 90, 70, 50, 32, 18, 8
      ]
    },
    {
      id: "max",
...
export const accounts: ReadonlyArray<Account> = mockAccounts.map((account, index) => ({
  ...account,
  currentPostingStreak: Math.max(0, 5 - (index % 6)),
  longestPostingStreak: 7 + (index % 8),
  postingActivity: Array.from({ length: 91 }, (_, dayIndex) => {
    const date = new Date(Date.UTC(2026, 6, 13) - (90 - dayIndex) * 24 * 60 * 60 * 1000)
    return {
      date: date.toISOString().slice(0, 10),
      posts: (dayIndex + index * 3) % (index % 4 === 0 ? 5 : 9) === 0 ? 1 + ((dayIndex + index) % 4) : 0
    }
  })
}))
